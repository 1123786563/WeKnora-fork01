...
export const SETTINGS_SECTIONS: readonly SettingsSection[] = [
  ...
  { key: 'models', viewId: 'ModelManagement', apiDomain: 'configuration.models', scope: 'tenant', minRole: 'admin', operations: ['read', 'save', 'test', 'delete'], ported: false },
  ...
  { key: 'members', viewId: 'TenantMemberSettings', apiDomain: 'identity.tenants.members', scope: 'tenant', minRole: 'admin', operations: ['read', 'save', 'delete'], ported: false },
