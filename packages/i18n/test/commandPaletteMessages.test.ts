...
const SAMPLE_KEYS = [
  ...
  // R464-A1 live-search groups + scope chip + match badges (Vue useSearch parity).
  'commandPalette.group.chunks',
  'commandPalette.group.messages',
  'commandPalette.group.kbs',
  'commandPalette.group.agents',
  'commandPalette.group.sessionsByTitle',
  'commandPalette.match.vector',
  'commandPalette.match.keyword',
  'commandPalette.scope.placeholder',
  'commandPalette.scope.remove',
  'commandPalette.untitledSession',
