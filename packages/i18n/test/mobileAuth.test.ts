...
const keys = ['mobileAuth.invitationExpires', 'mobileAuth.serverTitle', 'mobileAuth.serverHint', 'mobileAuth.serverPlaceholder', 'mobileAuth.saveServer', 'mobileAuth.savingServer', 'mobileAuth.serverSaveFailed'];
