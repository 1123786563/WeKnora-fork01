export default {
  apps: {
    ...
    catalog: {
      title: 'アプリカタログ',
      description: 'このワークスペースで審査済みかつ公開されたアクションと、その権限スコープです。下にはインストール済みアプリのバージョンを表示します。ランタイムアドレス・シークレット参照・内部エイリアスは表示しません。',
      refresh: '更新',
      loadFailed: 'アプリカタログの読み込みに失敗しました',
      empty: '利用可能なアクションはありません',
      installedTitle: 'インストール済みアプリ',
      installedEmpty: 'インストール済みアプリはありません',
      colAction: 'アクション',
      colApp: 'アプリ',
      colVersion: 'バージョン',
      colState: '状態',
      ...
      colProvider: 'プロバイダー',
      colRisk: 'リスク',
      colPermissions: '必要な権限',
      colSchemaDigest: 'スキーマダイジェスト',
      colConnection: '接続',
      colPublished: '公開状態',
      published: '公開済み',
      unpublished: '未公開',
    ...
    connections: {
      ...
      kindPersonal: '個人',
      kindSpace: 'スペース',
      accountSpace: 'ワークスペース共有',
      accountUnknown: '—',
      startAuthorization: '認可',
      startAuthorizationFailed: '認可の開始に失敗しました',
      revoke: '切断',
      revokeConfirmContent: '切断すると、このワークスペースは直ちにこの接続の認可を失います。リモート側のクリーンアップはバックグラウンドで続行する場合があります。切断しますか？',
      revokeSuccess: '接続を切断しました（ローカルは即時反映、リモートのクリーンアップはバックグラウンドで実行中）',
      revokeConflict: '接続の認可バージョンが変更されました。更新して再試行してください',
      revokeFailed: '接続の切断に失敗しました',
    ...
    authorization: {
      ...
      statusLabel: '状態',
      expiresLabel: '有効期限',
      noUrlGuidance: 'このデプロイでは外部認可 URL を返しません。open-connector コントロールプレーンからの通知で外部認可を完了してください。完了後、このページは自動的に更新されます。',
      pollingHint: '外部認可の完了を待機しています。状態は自動的に更新されます…',
      completedHint: '認可が完了し、接続が有効になりました。',
      back: '接続一覧に戻る',
      status: {
        pending: '待機中',
        authorizing: '認可中',
    ...
    actions: {
      ...
      targetLabel: 'ターゲット',
      riskLabel: 'リスク',
      riskUnknownHint: '現在の API はこのフィールドを返しません。リスクはサーバー側で凍結されています',
      stateLabel: '状態',
      digestLabel: 'コンテンツダイジェスト',
      fenceLabel: 'バージョンフェンス',
      argsLabel: '引数',
      approve: '承認',
      execute: '実行',
      unknown: '結果確認待ち',
      noResendHint: '結果確認待ちの間は再送できません。プロバイダーの照会結果をお待ちください。',
      memberCannotApprove: '現在のロールではアクションを承認・実行できません（ワークスペースのオーナーまたは管理者が必要です）。',
