export default {
  apps: {
    ...
    catalog: {
      title: '앱 카탈로그',
      description: '이 워크스페이스에 검토 후 게시된 액션과 권한 범위입니다. 하단에 설치된 앱 버전이 표시됩니다. 런타임 주소, 시크릿 참조, 내부 별칭은 표시하지 않습니다.',
      refresh: '새로 고침',
      loadFailed: '앱 카탈로그를 불러오지 못했습니다',
      empty: '사용 가능한 액션이 없습니다',
      installedTitle: '설치된 앱',
      installedEmpty: '설치된 앱이 없습니다',
      colAction: '액션',
      colApp: '앱',
      colVersion: '버전',
      colState: '상태',
      ...
      colProvider: '제공자',
      colRisk: '위험도',
      colPermissions: '필요 권한',
      colSchemaDigest: '스키마 다이제스트',
      colConnection: '연결',
      colPublished: '게시 상태',
      published: '게시됨',
      unpublished: '미게시',
    ...
    connections: {
      ...
      kindPersonal: '개인',
      kindSpace: '스페이스',
      accountSpace: '워크스페이스 공유',
      accountUnknown: '—',
      startAuthorization: '권한 부여',
      startAuthorizationFailed: '권한 부여 시작에 실패했습니다',
      revoke: '연결 해제',
      revokeConfirmContent: '연결을 해제하면 이 워크스페이스는 즉시 해당 연결 권한을 잃습니다. 원격 정리는 백그라운드에서 계속될 수 있습니다. 연결을 해제하시겠습니까?',
      revokeSuccess: '연결이 해제되었습니다(로컬은 즉시 적용, 원격 정리는 백그라운드에서 진행)',
      revokeConflict: '연결 권한 버전이 변경되었습니다. 새로 고침 후 다시 시도하세요',
      revokeFailed: '연결 해제에 실패했습니다',
    ...
    authorization: {
      ...
      statusLabel: '상태',
      expiresLabel: '만료 시각',
      noUrlGuidance: '이 배포는 외부 권한 부여 URL을 반환하지 않습니다. open-connector 컨트롤 플레인이 보낸 알림을 통해 외부 권한 부여를 완료하세요. 완료 후 이 페이지는 자동으로 갱신됩니다.',
      pollingHint: '외부 권한 부여 완료를 기다리는 중입니다. 상태는 자동으로 갱신됩니다…',
      completedHint: '권한 부여가 완료되어 연결이 활성화되었습니다.',
      back: '연결 목록으로 돌아가기',
      status: {
        pending: '대기 중',
        authorizing: '권한 부여 중',
    ...
    actions: {
      ...
      targetLabel: '대상',
      riskLabel: '위험도',
      riskUnknownHint: '현재 API는 이 필드를 반환하지 않습니다. 위험도는 서버에서 고정됩니다',
      stateLabel: '상태',
      digestLabel: '콘텐츠 다이제스트',
      fenceLabel: '버전 펜스',
      argsLabel: '인자',
      approve: '승인',
      execute: '실행',
      unknown: '결과 확인 대기',
      noResendHint: '결과 확인 대기 중에는 재전송할 수 없습니다. 제공자 조회 결과를 기다려 주세요.',
      memberCannotApprove: '현재 역할은 액션을 승인하거나 실행할 수 없습니다(워크스페이스 소유자 또는 관리자 필요).',
  ...
  datasource: {
    ...
    deletePanelPurgeLabel: '동기화된 {count}건의 문서도 함께 삭제',
    deletePanelPurgeLabelUnknown: '동기화된 모든 문서도 함께 삭제',
    deletePanelPurgeWarning: '지식베이스에서 {count}건의 문서와 해당 벡터/인덱스가 영구 삭제되며 복구할 수 없습니다.',
    deletePanelPurgeWarningUnknown: '지식베이스에서 동기화된 모든 문서와 해당 벡터/인덱스가 영구 삭제되며 복구할 수 없습니다.',
    deleteAndPurge: '데이터 소스 및 문서 삭제',
    deleteSuccessPurged: '데이터 소스와 동기화된 문서가 삭제되었습니다',
    syncNow: '지금 동기화',
    ...
    syncError: {
      ...
      // codes; English copy for now, same as the React ko-KR bundle.
