export default {
  apps: {
    ...
    catalog: {
      title: 'App catalog',
      description: 'Reviewed actions published for this workspace and their permission scopes; installed app versions are listed below. Runtime addresses, secret references and internal aliases are never shown.',
      refresh: 'Refresh',
      loadFailed: 'Failed to load the app catalog',
      empty: 'No actions available',
      installedTitle: 'Installed apps',
      installedEmpty: 'No installed apps',
      colAction: 'Action',
      colApp: 'App',
      colVersion: 'Version',
      colState: 'State',
    ...
    connections: {
      ...
      description: 'App connections of this workspace, distinguishing personal and space connections and their account ownership. Runtime addresses, secret references and internal aliases are never shown.',
      refresh: 'Refresh',
      loadFailed: 'Failed to load connections',
      empty: 'No connections',
      memberCannotManage: 'Your role cannot manage connections (workspace owner or admin required).',
      colId: 'Connection',
      colKind: 'Kind',
      colAccount: 'Account',
      colState: 'State',
      ...
      kindSpace: 'Space',
      accountSpace: 'Workspace shared',
      accountUnknown: '—',
      startAuthorization: 'Authorize',
      startAuthorizationFailed: 'Failed to start authorization',
      revoke: 'Disconnect',
      revokeConfirmContent: 'Disconnecting immediately revokes this connection for the workspace; remote cleanup may still be running in the background. Disconnect it?',
      revokeSuccess: 'Connection disconnected (local revocation effective; remote cleanup continues in the background)',
      revokeConflict: 'The connection authorization version changed — refresh and retry',
      revokeFailed: 'Failed to disconnect the connection',
      remoteCleanupNote: 'Locally disconnected; remote cleanup completes asynchronously',
    },
    authorization: {
      title: 'Authorization status',
      description: 'Polling the local authorization attempt until the external authorization completes.',
      refresh: 'Refresh',
      loadFailed: 'Failed to load the authorization status',
      attemptLabel: 'Authorization attempt',
      connectionLabel: 'Connection',
      statusLabel: 'Status',
      expiresLabel: 'Expires at',
      noUrlGuidance: 'This deployment returns no external authorization URL: complete the authorization via the notification sent by the open-connector control plane; this page updates automatically afterwards.',
      pollingHint: 'Waiting for the external authorization to complete; the status refreshes automatically…',
      completedHint: 'Authorization completed; the connection is active.',
    ...
    actions: {
      ...
      description: 'The server-frozen call snapshot (account, target, arguments); approving binds exactly this snapshot.',
      refresh: 'Refresh',
      loadFailed: 'Failed to load the action',
      notFound: 'Action not found or not in this workspace',
      accountLabel: 'Account (connection)',
      targetLabel: 'Target',
      riskLabel: 'Risk',
      riskUnknownHint: 'This field is not returned by the current API; the risk is frozen server-side',
      stateLabel: 'State',
      digestLabel: 'Content digest',
      fenceLabel: 'Version fence',
      argsLabel: 'Arguments',
      approve: 'Approve',
      execute: 'Execute',
      unknown: 'Outcome pending verification',
      noResendHint: 'No resend while the outcome is pending verification; wait for the provider query result.',
      memberCannotApprove: 'Your role cannot approve or execute actions (workspace owner or admin required).',
  ...
  datasource: {
    ...
    deleteFailed: 'Failed to delete',
    deletePanelTitle: 'Delete data source {name}',
    deletePanelKeep: 'Only the data source is deleted; documents already synced into the knowledge base are kept.',
    deletePanelCount: 'Synced documents: {count}',
    deletePanelPurgeLabel: 'Also delete these {count} synced documents',
    deletePanelPurgeLabelUnknown: 'Also delete all synced documents',
    deletePanelPurgeWarning: 'This will permanently delete {count} documents and their vectors/indexes from the knowledge base. This cannot be undone.',
    deletePanelPurgeWarningUnknown: 'This will permanently delete all synced documents and their vectors/indexes from the knowledge base. This cannot be undone.',
    deleteAndPurge: 'Delete data source and documents',
    deleteSuccessPurged: 'Data source and its synced documents were deleted',
    syncNow: 'Sync Now',
    ...
    syncError: {
      ...
      // SP2-b Task 8: per-item connector failure codes + the three targeted
      // reindex codes, copied from the React bundle (dataSource.syncError.*).
