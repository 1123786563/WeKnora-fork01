export default {
  apps: {
    ...
    connections: {
      ...
      accountSpace: '空间共享',
      accountUnknown: '—',
      startAuthorization: '授权',
      startAuthorizationFailed: '发起授权失败',
      revoke: '断开',
      revokeConfirmContent: '断开后本空间立即失去该连接授权；远端清理可能仍在后台进行。确定断开吗？',
      revokeSuccess: '连接已断开（本地已生效；远端清理在后台进行）',
      revokeConflict: '连接授权版本已变化，请刷新后重试',
      revokeFailed: '断开连接失败',
    ...
    authorization: {
      ...
      pollingHint: '正在等待外部授权完成，状态将自动刷新…',
      completedHint: '授权已完成，连接已生效。',
      back: '返回连接列表',
      status: {
        pending: '等待授权',
        authorizing: '授权中',
    ...
    actions: {
      ...
      targetLabel: '目标',
      riskLabel: '风险',
      riskUnknownHint: '当前接口未返回该字段；风险以服务端冻结数据为准',
      stateLabel: '状态',
      digestLabel: '内容指纹',
      fenceLabel: '版本围栏',
      argsLabel: '参数',
  ...
  datasource: {
    ...
    deletePanelPurgeLabel: '同时删除这 {count} 篇同步文档',
    deletePanelPurgeLabelUnknown: '同时删除全部已同步文档',
    deletePanelPurgeWarning: '将从知识库中永久删除 {count} 篇文档及其向量/索引，不可恢复。',
    deletePanelPurgeWarningUnknown: '将从知识库中永久删除全部已同步文档及其向量/索引，不可恢复。',
    deleteAndPurge: '删除数据源及文档',
    deleteSuccessPurged: '数据源及已同步文档已删除',
    syncNow: '立即同步',
