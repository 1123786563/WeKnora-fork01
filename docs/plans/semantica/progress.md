...
状态：V01、V02、C01、C02、C03 已按各自证据层和验收门槛标记为 verified；I01、I02 正在独立 worktree 实施；其余 17 个正式任务仍为 pending。先导 probe 另行留证，不替代 V03 或生产验收。总计划：[实施入口](../2026-09-11-semantica-implementation.md)，校准入口：[2026-09-20 rebaseline](../2026-09-20-semantica-rebaseline.md)。ADR-0002 与 rebaseline 优先于旧计划中的未验证建议。
...
| I01 | 持久操作、幂等与worker租约 | C02 | in_progress | 2026-09-21: detailed plan `2026-09-21-semantic-i01-persistent-operations.md`; separate Python service PostgreSQL schema, real-PG fixture required, no C01 protocol change. Implementation pending dispatch. |
| I02 | 业务revision、outbox与授权版本 | C01 | in_progress | 2026-09-21: detailed plan `2026-09-21-semantic-i02-business-outbox.md`; current migration heads verified at PG177/SQLite98, reserving 178/99; only revision/outbox/access epoch/denial tables in this slice. Implementation pending dispatch. |
