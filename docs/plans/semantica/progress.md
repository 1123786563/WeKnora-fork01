...
状态：V01 已经独立 review、修复并以 actual-runtime 证据标记为 verified；其余 23 个正式任务仍为 pending。先导 probe 另行留证，不替代 V02/V03 或生产验收。总计划：[实施入口](../2026-09-11-semantica-implementation.md)，校准入口：[2026-09-20 rebaseline](../2026-09-20-semantica-rebaseline.md)。ADR-0002 与 rebaseline 优先于旧计划中的未验证建议。
...
| V02 | 验证持久图桥接和两类推理 | V01 | implemented | 2026-09-20 dedicated local `real-storage` evidence: Semantica `0.6.8`, V01 lock `c643ce123490c93f56ed95e9d6501bbd90daf8b2cdc74b183067dccd63864c54`, V02 lock `7cea23660879d96120a8936b44d9c23d4aaaf036b31c9a4e79812d31a4efe709`; writer/reader separate processes and post-container-restart roundtrip retain `a-d1/a-d2`, `e-d1/e-d2` and provenance while backend scope query excludes `a-foreign`. Evidence [v02-dedicated.json](evidence/2026-09-20/v02-dedicated.json), report [bridge-evidence.md](bridge-evidence.md). Commands exited 0: V02 pytest 7 passed; dedicated capture and container restart/re-capture. `verified` remains blocked on a real shared-isolated boundary, identical comparison evidence, and a recorded topology selection. No provider/model, Go authorization, ACL/revocation, quality, performance, budget, or production claim. |
