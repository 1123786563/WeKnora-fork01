...
| C01 | 版本化协议和跨语言领域类型 | V01 | implemented | 2026-09-20: proto/generator commit `4c835855b209d9c6d545ded6166f6a4a8221afbf`, mapping commit `83fdeb1652b3ff7bb76c69e5a162d492b77ed434`; dedicated `weknora.semantic.v1` schema with seven RPCs, generated Go/Python bindings, transport-neutral Go/Python DTO seam. Commands exit 0: proto descriptor Python test; `go test ./semantic/proto`; `go test ./internal/types -run TestSemantic -count=1`; `uv run --project semantic python -m pytest semantic/tests -q` (3 passed). Generator versions are recorded in `semantic/proto/GENERATOR_VERSIONS.md`. Review pending; excludes RPC client/server, authority issuance, Assertion/Derivation, generation manifests, provider/model and storage implementation. |
