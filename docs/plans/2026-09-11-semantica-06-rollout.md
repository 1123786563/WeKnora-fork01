...
- [ ] **8. 留证与提交**。更新 `docs/plans/semantica/progress.md` 的 O01 行，附准确命令、退出码、环境和产物位置；只暂存上述任务文件中的本任务变更，提交 `feat(semantic): o01 独立部署、探针与可观测性`。
...
- `docs/plans/semantica/recovery-evidence.md`：故障与恢复实测
- `docs/plans/semantica/recovery-runbook.md`：实际恢复步骤
...
- [ ] **8. 留证与提交**。更新 `docs/plans/semantica/progress.md` 的 O02 行，附准确命令、退出码、环境和产物位置；只暂存上述任务文件中的本任务变更，提交 `feat(semantic): o02 故障注入、清理与恢复演练`。
...
- `docs/plans/semantica/final-evidence.md`：五层能力证据与验收域汇总
- `docs/plans/semantica/progress.md`：最终逐任务状态
...
- [ ] **8. 留证与提交**。更新 `docs/plans/semantica/progress.md` 的 O03 行，附准确命令、退出码、环境和产物位置；只暂存上述任务文件中的本任务变更，提交 `feat(semantic): o03 质量回归、CI门禁与最终交付`。
