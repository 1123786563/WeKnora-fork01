...
- [ ] **8. 留证与提交**。更新 `docs/plans/semantica/progress.md` 的 Q01 行，附准确命令、退出码、环境和产物位置；只暂存上述任务文件中的本任务变更，提交 `feat(semantic): q01 GraphRAG检索与有界执行`。
...
- [ ] **7. 留证与提交**。更新 `docs/plans/semantica/progress.md` 的 Q02 行，附准确命令、退出码、环境和产物位置；只暂存上述任务文件中的本任务变更，提交 `feat(semantic): q02 注册规则与可核验推导`。
...
- [ ] **8. 留证与提交**。更新 `docs/plans/semantica/progress.md` 的 Q03 行，附准确命令、退出码、环境和产物位置；只暂存上述任务文件中的本任务变更，提交 `feat(semantic): q03 模型推断与证据不足判定`。
...
- [ ] **8. 留证与提交**。更新 `docs/plans/semantica/progress.md` 的 Q04 行，附准确命令、退出码、环境和产物位置；只暂存上述任务文件中的本任务变更，提交 `feat(semantic): q04 Go检索融合、Agent工具与最终授权`。
