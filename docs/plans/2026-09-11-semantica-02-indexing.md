...
- [ ] **7. 留证与提交**。更新 `docs/plans/semantica/progress.md` 的 I01 行，附准确命令、退出码、环境和产物位置；只暂存上述任务文件中的本任务变更，提交 `feat(semantic): i01 持久操作、幂等与worker租约`。
...
- [ ] **8. 留证与提交**。更新 `docs/plans/semantica/progress.md` 的 I02 行，附准确命令、退出码、环境和产物位置；只暂存上述任务文件中的本任务变更，提交 `feat(semantic): i02 业务revision、outbox与授权版本`。
...
- [ ] **8. 留证与提交**。更新 `docs/plans/semantica/progress.md` 的 I03 行，附准确命令、退出码、环境和产物位置；只暂存上述任务文件中的本任务变更，提交 `feat(semantic): i03 有来源的构图与generation原子发布`。
...
- [ ] **8. 留证与提交**。更新 `docs/plans/semantica/progress.md` 的 I04 行，附准确命令、退出码、环境和产物位置；只暂存上述任务文件中的本任务变更，提交 `feat(semantic): i04 删除屏障、支持撤销和清理receipt`。
...
- [ ] **8. 留证与提交**。更新 `docs/plans/semantica/progress.md` 的 I05 行，附准确命令、退出码、环境和产物位置；只暂存上述任务文件中的本任务变更，提交 `feat(semantic): i05 文档任务、attempt与终态协调`。
