...
| D01 | review | .worktrees/craft-d01 / codex/craft-d01 | 92f23a10 | HEAD e0fc78e0：python-docx 镜像链+OOXML 校验+浏览器 4/4；五项类型接线全落地（EntryPath/Previewable/manifest 服务端门禁/NIT-1 词边界/预览归一/kind-aware specs）；审查者进行中（合入后仅剩 O05） |
