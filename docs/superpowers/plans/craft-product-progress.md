...
| C06 | review | .worktrees/craft-c06 / codex/craft-c06 | 88065cfe | 主体 a235fd6a+集成三项 4c5fa520：SkillPin+受控追加检索（默认关）+知识装配/交互挂载/idle 措辞；修复集成 HEAD 预存 dig 启动环（stash 归因）；W06 栈 6/6+2/2；knowledge_scope 持久化留后续；审查者进行中 |
| O03 | implementing | .worktrees/craft-o03 / codex/craft-o03 | de94676e | 已派发（休眠/删除分策+Sweep CAS+worker 竞争测试） |
| D03 | implementing | .worktrees/craft-d03 / codex/craft-d03 | de94676e | 已派发（python-pptx+LO/PDF 渲染+逐页预览+浏览器单页修改）；D01/O03/O04/O05 等待依赖或席位 |
