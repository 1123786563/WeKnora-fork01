...
| W15 | [供应商投递、回执与重试](2026-09-12-mobile-workbench-03-notifications.md) | fixing | notifications | `c62655dc`, `2ef77b60` | notification tests/config/diff GREEN；workbench/W20/PG/provider live blocked-env | provider wiring follow-up in progress | production worker lifecycle start、permanent revoke、Expo/AccessToken provider selection、Retry-After gateway、partial batch retry remain | W16 queued |
...
| W23 | [个人节点出站注册与撤销](2026-09-12-mobile-workbench-04-paseo.md) | fixing | remote | `fa2d160c`, `5e5fb6ac`, `59b3c7f1`, `d7657d26`, `9bc2cee8`, `81a70b94`, `ea69c27d`, `6bb23b09`, `7f4fc069`, `40c0f6a1`, `1760d3e5` | Paseo 29/29、bootstrap 5/5、diff GREEN；Go/mobile deps/live blocked-env | bridge contract/layout follow-up in progress | async Wails Promise type contract、executable keychain failure test、rendered RootLayout provider wiring remain | W24/W37 locked |
