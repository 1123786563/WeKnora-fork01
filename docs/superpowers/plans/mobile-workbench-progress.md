...
| W23 | [个人节点出站注册与撤销](2026-09-12-mobile-workbench-04-paseo.md) | reviewing | remote | `fa2d160c`, `5e5fb6ac`, `59b3c7f1`, `d7657d26`, `428f7a9e` | Paseo 5/5、typecheck、execution race、diff GREEN；W20/DB/live node blocked-env | revoke/composition review pending | transactional revoke cascade、rollback test、admission matrix、SQLite/Gin lifecycle、production connector factory added | W24 remains locked |
