...
| W13 | [设备注册与账号切换撤销](2026-09-12-mobile-workbench-03-notifications.md) | reviewing | notifications | `a71f1128a0db57ce7fac153ae00810c5363f0b2b`, `ffd1b2bc`, `d06ffe0d` | repository/race focused GREEN；full Go blocked by W20 remote_dispatch；mobile dependency unavailable | round-3 independent review pending | logout/revoke now atomically advances scope epoch; revisionless replay and ProductAuthProvider epoch persistence added | W14 remains locked until review PASS |
...
| W22 | [远程取消、审批和工作目录锁](2026-09-12-mobile-workbench-04-paseo.md) | fixing | remote | `f2b91e4e`, `08c135bf`, `d0356398` | round-2 focused Go/Paseo/typecheck/race/vet GREEN；SQLite migration 000055 baseline blocked | round-3 implementation in progress | round-2 Spec FAIL / Quality CHANGES_REQUIRED: lease lifecycle, target credential version, provider epoch, durable approval retry, payloadHash, mutex race, crash receipt cancel, control fixture contract | W23/W24/W32 remain locked |
