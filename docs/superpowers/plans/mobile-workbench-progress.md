...
| W22 | [远程取消、审批和工作目录锁](2026-09-12-mobile-workbench-04-paseo.md) | fixing | remote | `f2b91e4e`, `08c135bf`, `d0356398`, `261a4143` | round-3 focused tests/race/vet/typecheck/Paseo/diff GREEN；SQLite/live Paseo blocked-env | round-4 final fix in progress | remaining P1: durable approval retry, accepted:false propagation, fail-closed credential version, lease release after restart | W23/W24/W32 remain locked |
