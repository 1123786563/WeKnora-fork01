...
| W15 | [供应商投递、回执与重试](2026-09-12-mobile-workbench-03-notifications.md) | reviewing | notifications | `c62655dc`, `2ef77b60`, `76f2d6e6` | notification tests/config/diff GREEN；workbench/W20/PG/provider live blocked-env | provider wiring review pending | lifecycle start/shutdown、permanent revoke、Expo/AccessToken selection、Retry-After propagation added; batch partial receipt and pause/alert remain explicit limitations | W16 queued |
...
| W23 | [个人节点出站注册与撤销](2026-09-12-mobile-workbench-04-paseo.md) | fixing | remote | `fa2d160c`, `5e5fb6ac`, `59b3c7f1`, `d7657d26`, `9bc2cee8`, `81a70b94`, `ea69c27d`, `6bb23b09`, `7f4fc069`, `40c0f6a1`, `1760d3e5`, `da326017` | bridge/layout tests/diff GREEN；desktop/mobile/Darwin deps/Go/PG/live blocked-env | async Paseo promise fix in progress | personalNodeApp still treats GetPaseoURL/AllowedOrigins sync and calls trim/filter before await | W24/W37 locked |
