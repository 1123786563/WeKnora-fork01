...
| W13 | [设备注册与账号切换撤销](2026-09-12-mobile-workbench-03-notifications.md) | fixing | notifications | `a71f1128a0db57ce7fac153ae00810c5363f0b2b`, `ffd1b2bc` | repository/race focused GREEN；full Go blocked by W20 remote_dispatch；mobile dependency unavailable | round-3 implementation in progress | round-2 Spec FAIL / Quality CHANGES_REQUIRED: logout/revoke must advance scope epoch, revision-less late registration must be rejected, RevokeBeforeScopeGeneration not wired through ProductAuthProvider lifecycle | W14 remains locked |
