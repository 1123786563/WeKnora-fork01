...
| W13 | [设备注册与账号切换撤销](2026-09-12-mobile-workbench-03-notifications.md) | reviewing | notifications | `a71f1128a0db57ce7fac153ae00810c5363f0b2b`, `ffd1b2bc`, `d06ffe0d`, `44107dc3`, `31016abe`, `e73f6edd`, `696de738` | focused Go count/race/vet/diff GREEN；mobile deps blocked-env | final independent review pending | pre-await lifecycle invalidation、A/B queue isolation、unique temp DBs、deterministic Bind/Revoke assertions added | W14 remains locked |
...
| W23 | [个人节点出站注册与撤销](2026-09-12-mobile-workbench-04-paseo.md) | fixing | remote | `fa2d160c` | focused Go registration、Paseo 3/3、typecheck、diff GREEN；W20/DB/live node blocked-env | targeted fix in progress | revoked replay P0、ExecutionTarget/W20 identity、route contract、real connector heartbeat/ack/log/rotation、coverage gaps | W24 remains locked |
