...
| W13 | [设备注册与账号切换撤销](2026-09-12-mobile-workbench-03-notifications.md) | reviewing | notifications | `a71f1128a0db57ce7fac153ae00810c5363f0b2b`, `ffd1b2bc`, `d06ffe0d`, `44107dc3`, `31016abe`, `e73f6edd` | focused Go/race/vet/diff GREEN；mobile dependency blocked-env | lifecycle review pending | account-switch revision reset、AbortSignal/lifecycle fencing、permission/offline/logout tests、true Bind/Revoke race added | W14 remains locked until review PASS |
...
| W23 | [个人节点出站注册与撤销](2026-09-12-mobile-workbench-04-paseo.md) | implementing | remote | 未提交 | 实施中 | 未审查 | W17-W22 accepted-with-blockers; W22 targeted review PASS | W24 may dispatch when slot frees |
