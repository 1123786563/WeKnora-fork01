...
| W14 | [事务事件到通知 Outbox](2026-09-12-mobile-workbench-03-notifications.md) | reviewing | notifications | `773c8269`, `0ce9a045`, `8f638f0a`, `79c4e95a`, `4593b1c0`, `29713103` | gofmt/diff GREEN；Go tests blocked by W20, SQLite 000055 blocked-env | final worker race review pending | RunOnce provider races、stale fence、budget→intent→checkpoint→close/reopen replay added | W15/W16 remain locked |
...
| W23 | [个人节点出站注册与撤销](2026-09-12-mobile-workbench-04-paseo.md) | reviewing | remote | `fa2d160c`, `5e5fb6ac`, `59b3c7f1`, `d7657d26`, `9bc2cee8`, `81a70b94`, `ea69c27d` | execution/repository/router focused、Paseo 29/29、typecheck、diff GREEN；PG/complete Go/live blocked-env | fail-closed lifecycle review pending | nil provisioner fail-closed、legacy binding/credential/tenant checks、projection version consistency、real route lifecycle、runtime composition wiring added | W24/W37 remain locked |
