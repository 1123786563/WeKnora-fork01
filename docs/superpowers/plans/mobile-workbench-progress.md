...
| W15 | [供应商投递、回执与重试](2026-09-12-mobile-workbench-03-notifications.md) | fixing | notifications | `c62655dc`, `2ef77b60`, `76f2d6e6` | notification tests/config/diff GREEN；workbench/W20/PG/provider live blocked-env | revision-safe revoke follow-up in progress | permanent failure revoke still uses revision=0; batch partial retry and pause/alert remain explicit follow-ups | W16 queued |
...
| W24 | [受控工具、可信用量与预算树接线](2026-09-12-mobile-workbench-04-paseo.md) | implementing | remote | 未提交 | 实施中 | 未审查 | W04/W20/W21/W22/W23 accepted-with-blockers; W23 Promise review PASS | W30/W33/W34 downstream |
