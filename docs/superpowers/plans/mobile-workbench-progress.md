...
| W13 | [设备注册与账号切换撤销](2026-09-12-mobile-workbench-03-notifications.md) | reviewing | notifications | `a71f1128a0db57ce7fac153ae00810c5363f0b2b`, `ffd1b2bc`, `d06ffe0d`, `44107dc3`, `31016abe` | repository/handler focused tests、race、diff GREEN；full Go/mobile blocked-env | targeted independent review pending | atomic Bind/revoke row-lock fencing、server epoch header persistence、tenant/owner scoped offline revoke、lifecycle tests added | W14 remains locked until review PASS |
