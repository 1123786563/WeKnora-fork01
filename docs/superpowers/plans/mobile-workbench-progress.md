...
| W13 | [设备注册与账号切换撤销](2026-09-12-mobile-workbench-03-notifications.md) | reviewing | notifications | `a71f1128a0db57ce7fac153ae00810c5363f0b2b`, `ffd1b2bc`, `d06ffe0d`, `44107dc3` | handler/repository focused tests、diff GREEN；full Go blocked by W20 remote_dispatch；mobile deps unavailable | round-4 final independent review pending | server-signed registration intents、CurrentScopeGeneration、future epoch rejection、logout high-water preservation added | W14 remains locked until final review PASS |
...
| W22 | [远程取消、审批和工作目录锁](2026-09-12-mobile-workbench-04-paseo.md) | reviewing | remote | `f2b91e4e`, `08c135bf`, `d0356398`, `261a4143` | Go race/vet、Paseo 26/26、typecheck、HTTP fixture、diff GREEN；SQLite 000055/live Paseo blocked-env | round-3 independent review pending | lease lifecycle、target credential、provider epoch、durable cancel/approval、payload hash、mutex、Go/TS control contract fixes committed | W23/W24/W32 remain locked until review PASS |
