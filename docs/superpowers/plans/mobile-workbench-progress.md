...
| W13 | [设备注册与账号切换撤销](2026-09-12-mobile-workbench-03-notifications.md) | fixing | notifications | `a71f1128a0db57ce7fac153ae00810c5363f0b2b`, `ffd1b2bc` | repository/race focused、mobile registration、migration focused GREEN；full handler/migration suite blocked by baseline/env | second independent review pending | first review Spec FAIL / Quality CHANGES_REQUIRED; fixes committed, round-2 review dispatched | W14 remains locked until review PASS |
