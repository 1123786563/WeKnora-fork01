...
| W14 | [事务事件到通知 Outbox](2026-09-12-mobile-workbench-03-notifications.md) | fixing | notifications | `773c8269`, `0ce9a045`, `9fd57b40` | gofmt/diff GREEN；Go/PG blocked-env by W20/DSN | recovery follow-up in progress | W13 migration dependency、EventRunKeys pagination、atomic projection/checkpoint recovery、budget_exhausted producer、provider race wiring、000059 migration tests remain | W15/W16 locked |
...
| W23 | [个人节点出站注册与撤销](2026-09-12-mobile-workbench-04-paseo.md) | fixing | remote | `fa2d160c`, `5e5fb6ac`, `59b3c7f1`, `d7657d26` | Paseo 5/5、execution race、typecheck、diff GREEN；W20/DB/live node blocked-env | admission rollback follow-up in progress | revoked admission budget/pending rollback、production route invocation、connector runtime composition/bearer cleanup、binding consistency remain | W24/W37 locked |
