...
| W14 | [事务事件到通知 Outbox](2026-09-12-mobile-workbench-03-notifications.md) | reviewing | notifications | `773c8269` | diff GREEN、SQLite migration direct pass；W20 compile/PG blocked-env | independent review pending | intent idempotency、claim lease/fence、ack/retry、event filter、revocation/owner checks、projector replay implemented; migrations 000137/000059 due occupied planned numbers | W15/W16 remain downstream |
...
| W23 | [个人节点出站注册与撤销](2026-09-12-mobile-workbench-04-paseo.md) | reviewing | remote | `fa2d160c`, `5e5fb6ac`, `59b3c7f1` | Paseo tests/typecheck/diff GREEN；W20/DB/live node blocked-env | admission review pending | node_* admission、ExecutionTarget binding、RowsAffected consistency、configured allowlist/loopback policy added | W24 remains locked until review PASS |
