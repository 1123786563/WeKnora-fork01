...
| W14 | [事务事件到通知 Outbox](2026-09-12-mobile-workbench-03-notifications.md) | reviewing | notifications | `773c8269`, `0ce9a045`, `8f638f0a`, `79c4e95a`, `4593b1c0`, `29713103`, `d1fbcecb`, `f1fba39a` | focused new tests GREEN with W20 excluded；full workbench/SQLite blocked-env; existing fence=1 baseline recorded | interaction fence review pending | resolved interaction delivery rejection、Ack/Retry fence-loss errors/tests added; concurrent fence=1 baseline remains | W15/W16 locked |
...
| W23 | [个人节点出站注册与撤销](2026-09-12-mobile-workbench-04-paseo.md) | fixing | remote | `fa2d160c`, `5e5fb6ac`, `59b3c7f1`, `d7657d26`, `9bc2cee8`, `81a70b94`, `ea69c27d`, `6bb23b09` | adapter/route/composition focused GREEN；mobile/desktop production deps/PG/live blocked-env | production entry wiring in progress | mobile _layout and desktop main still do not pass personalNode config/registration client/trusted endpoint/credential bridge | W24/W37 locked |
