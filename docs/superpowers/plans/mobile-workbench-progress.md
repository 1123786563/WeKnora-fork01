...
| W13 | [设备注册与账号切换撤销](2026-09-12-mobile-workbench-03-notifications.md) | blocked-review | notifications | `a71f1128a0db57ce7fac153ae00810c5363f0b2b`, `ffd1b2bc`, `d06ffe0d`, `44107dc3` | focused repository/handler tests、gofmt、diff GREEN；full Go/mobile blocked-env | final review complete | P0: intent validation/Bind non-atomic; revoke epoch header not consumed; lifecycle tests absent; offline revoke lacks owner/tenant binding | W14 remains locked pending redesign/fix in a new plan cycle |
...
| W22 | [远程取消、审批和工作目录锁](2026-09-12-mobile-workbench-04-paseo.md) | blocked-review | remote | `f2b91e4e`, `08c135bf`, `d0356398`, `261a4143`, `d2e18040` | Go race/vet、Paseo 26/26、typecheck、HTTP fixture、diff GREEN；SQLite/live Paseo blocked-env | final review complete | P1: recovered lease release decodes workspaceRef while admission persists workspace_ref; exact provider retry argument assertion missing | W23/W24/W32 remain locked pending targeted redesign/fix |
