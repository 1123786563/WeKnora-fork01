...
| W23 | [个人节点出站注册与撤销](2026-09-12-mobile-workbench-04-paseo.md) | fixing | remote | `fa2d160c`, `5e5fb6ac` | focused Paseo/typecheck/diff GREEN；W20/DB/live node blocked-env | admission/integration follow-up in progress | node_* W20 admission、TargetProvisioner migration/RowsAffected、HTTP contract coverage、configured allowlist remain | W24 remains locked |
