...
| W14 | [事务事件到通知 Outbox](2026-09-12-mobile-workbench-03-notifications.md) | fixing | notifications | `773c8269`, `0ce9a045`, `8f638f0a`, `79c4e95a`, `4593b1c0`, `29713103`, `d1fbcecb`, `e015305c` | focused static/timezone GREEN；run/race blocked by W20 compile | retry error fix in progress | distinguish Retry CAS loss from DB errors; prevent IsSent from masking persistence failures; add error injection test | W15/W16 locked |
