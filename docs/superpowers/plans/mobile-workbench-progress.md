...
| W14 | [事务事件到通知 Outbox](2026-09-12-mobile-workbench-03-notifications.md) | reviewing | notifications | `773c8269`, `0ce9a045`, `9fd57b40`, `8f638f0a`, `2b6fc6c8`, `79c4e95a` | gofmt/diff GREEN；Go/full migration blocked by W20/000055 | final review pending | migration-backed 257th intent、rollback/restart replay、budget event、HTTP provider、production worker startup、provider revoke spy added | W15/W16 remain locked |
...
| W23 | [个人节点出站注册与撤销](2026-09-12-mobile-workbench-04-paseo.md) | reviewing | remote | `fa2d160c`, `5e5fb6ac`, `59b3c7f1`, `d7657d26`, `9bc2cee8`, `81a70b94`, `2dcb7278` | workbench/repository/router/handler focused+races GREEN、Paseo 7/7、typecheck、diff GREEN；live Paseo/PG blocked-env | final integration review pending | revoked admission rollback、production revoke facade、binding consistency、credential cleanup、W20 dispatch compile fix added | W24/W37 remain locked |
