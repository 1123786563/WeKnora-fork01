...
| W13 | [设备注册与账号切换撤销](2026-09-12-mobile-workbench-03-notifications.md) | fixing | notifications | `a71f1128a0db57ce7fac153ae00810c5363f0b2b`, `ffd1b2bc`, `d06ffe0d`, `44107dc3`, `31016abe` | focused repository/handler/race/vet/diff GREEN；full Go/mobile blocked-env | lifecycle follow-up implementation in progress | targeted review found cross-account revision reuse, stale async lifecycle generation, missing true concurrency and lifecycle regressions | W14 remains locked |
