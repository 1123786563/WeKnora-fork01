...
| W14 | [事务事件到通知 Outbox](2026-09-12-mobile-workbench-03-notifications.md) | fixing | notifications | `773c8269`, `0ce9a045`, `8f638f0a`, `79c4e95a`, `4593b1c0` | diff GREEN；worker/DB tests blocked by W20/SQLite 000055 | worker race/evidence follow-up in progress | RunOnce provider race、persisted claim/stale Ack、budget→projection→replay/checkpoint remain insufficient | W15/W16 remain locked |
