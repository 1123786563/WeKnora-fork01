...
| W14 | [事务事件到通知 Outbox](2026-09-12-mobile-workbench-03-notifications.md) | fixing | notifications | `773c8269`, `0ce9a045`, `8f638f0a`, `79c4e95a` | source wiring/diff GREEN；W20 compile/SQLite 000055 blocked-env | production evidence follow-up in progress | worker RunOnce >256、real restart/fault recovery、ExecuteDurableRun budget path、claim/revoke/member/stale-fence races remain unproven | W15/W16 locked |
