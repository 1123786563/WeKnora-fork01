...
| W13 | [设备注册与账号切换撤销](2026-09-12-mobile-workbench-03-notifications.md) | fixing | notifications | `a71f1128a0db57ce7fac153ae00810c5363f0b2b`, `ffd1b2bc`, `d06ffe0d` | repository/race focused GREEN；full Go blocked by W20 remote_dispatch；mobile dependency unavailable | round-4 final fix in progress | round-3 Spec FAIL / Quality CHANGES_REQUIRED: logout may lower epoch, server epoch remains guessable, lifecycle regression missing | W14 remains locked; final review required |
