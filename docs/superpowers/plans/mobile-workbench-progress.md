...
| W15 | [供应商投递、回执与重试](2026-09-12-mobile-workbench-03-notifications.md) | fixing | notifications | `c62655dc`, `2ef77b60`, `76f2d6e6`, `b1d5ad70` | notification/race/vet/diff GREEN；workbench/W20/PG/provider live blocked-env | batch/pause follow-up in progress | revision-safe revoke fixed; batch partial retry and durable pause/alert/recovery remain | W16 queued |
| W16 | [安全深链与待处理卡](2026-09-12-mobile-workbench-03-notifications.md) | pending | 尚未执行 | 无实现提交 | 等待并行槽位 | 未审查 | W14 accepted-with-blockers；准备在 reviewer 槽位释放后并行启动 |
...
| W24 | [受控工具、可信用量与预算树接线](2026-09-12-mobile-workbench-04-paseo.md) | fixing | remote | `a9404191` | focused execution/workbench/commercial tests/diff GREEN；PG/OpenMeter/Paseo/payment/W20 blocked-env | integration fix in progress | real entry wiring、server trusted source、child budget reuse、server usage identity、BYOK Begin/Finish、required commercial/container files remain | W30/W33/W34 locked |
