...
| W15 | [供应商投递、回执与重试](2026-09-12-mobile-workbench-03-notifications.md) | reviewing | notifications | `c62655dc`, `2ef77b60` | notification package/config/diff GREEN；workbench/W20/PG/provider live blocked-env | independent review pending | receipt parsing、permanent/429/transient errors、Retry-After/jitter、fenced retry/ack/expire、migrations/config implemented | W16 remains eligible but queued |
