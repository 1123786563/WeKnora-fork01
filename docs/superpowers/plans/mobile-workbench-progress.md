...
| W14 | [事务事件到通知 Outbox](2026-09-12-mobile-workbench-03-notifications.md) | fixing | notifications | `773c8269` | SQLite DDL direct pass；W20 compile/PG blocked-env | targeted wiring fix in progress | production container/event consumer wiring、persisted event validation、revoke/owner TOCTOU、durable cursor/checkpoint remain | W15/W16 locked |
...
| W23 | [个人节点出站注册与撤销](2026-09-12-mobile-workbench-04-paseo.md) | fixing | remote | `fa2d160c`, `5e5fb6ac`, `59b3c7f1` | Paseo/typecheck/diff GREEN；W20/DB/live node blocked-env | revoke/transport follow-up in progress | target revoke must cascade registration/identity/version; production transport DI/lifecycle; full admission matrix and SQLite/Gin integration tests remain | W24 locked |
