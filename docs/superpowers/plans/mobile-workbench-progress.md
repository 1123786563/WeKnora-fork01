...
| W14 | [事务事件到通知 Outbox](2026-09-12-mobile-workbench-03-notifications.md) | implementing | notifications | 未提交 | 实施中 | 未审查 | W03/W05/W13 accepted-with-blockers；W13 final review PASS | W15/W16 remain downstream |
...
| W23 | [个人节点出站注册与撤销](2026-09-12-mobile-workbench-04-paseo.md) | reviewing | remote | `fa2d160c`, `5e5fb6ac` | Go race、Paseo 26/26、typecheck、diff GREEN；W20/DB/live node blocked-env | final independent review pending | revoked replay rejection、transactional ExecutionTarget binding、contract routes、concrete Paseo transport added | W24 remains locked until review PASS |
