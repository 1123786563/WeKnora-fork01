...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| P0-1 固定功能基线与证据台账 | 已确认规格、当前源码、活跃客户端 manifests | P0 Task 1 implementer | `da16fcf5`, `a64d2640` | passed（文档覆盖审查；round 2 文档修正待提交） | round 1 re-review finding addressed; re-review pending | round 1 re-review finding addressed; re-review pending | static inventory / TSV schema | `awk -F '\t' ... features.tsv`; `git diff --check` | `.superpowers/sdd/2026-09-19-trpc-native-agent-p0/task-1-report.md` | local isolated worktree; no service/provider/device started | P2 SDK probe、P3/P7 恢复、P1 数据权威、P4 能力接入、P5 客户端、P6/P7 archive/cutover |
