...
The confirm shell must still be expanded to the Vue state model before review: picker visual/navigation parity, full PDF section presentation, reparse source preview/action parity, locale-derived feedback, and actual authenticated browser interaction evidence.
