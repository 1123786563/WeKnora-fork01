...
CREATE TABLE agent_marketplace_listings (
 ...
 current_release_id VARCHAR(36), created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE agent_release_submissions (
 id VARCHAR(36) NOT NULL, tenant_id INTEGER NOT NULL, listing_id VARCHAR(36) NOT NULL, agent_version_id VARCHAR(36) NOT NULL,
...
CREATE TABLE agent_release_reviews (
 ...
 reviewed_digest VARCHAR(64) NOT NULL, decision VARCHAR(32) NOT NULL, reason TEXT NOT NULL DEFAULT '', created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
