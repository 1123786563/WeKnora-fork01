...
CREATE TABLE semantic_outbox (
  ...
  revision TEXT NOT NULL, content_hash TEXT NOT NULL, deleted INTEGER NOT NULL CHECK(deleted IN (0,1)), payload BLOB NOT NULL, payload_hash TEXT NOT NULL,
  attempt_count INTEGER NOT NULL DEFAULT 0, lease_token INTEGER NOT NULL DEFAULT 0, lease_expires_at DATETIME, retry_at DATETIME NOT NULL, error_code TEXT NOT NULL DEFAULT ''
);
