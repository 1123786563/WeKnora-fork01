...
ALTER TABLE semantic_completion_receipts ADD COLUMN IF NOT EXISTS attempt BIGINT;
ALTER TABLE semantic_completion_receipts ADD COLUMN IF NOT EXISTS operation_id VARCHAR(128);
