...
const DEV_PROXY_TARGET = process.env.VITE_DEV_PROXY_TARGET || process.env.FRONTEND_BACKEND_URL || 'http://localhost:8080';
const backendProxy = { target: DEV_PROXY_TARGET, changeOrigin: true, secure: false, ws: true };
