...
export function ConfigurationEditor({ client, section, record, onSaved, onCancel }: {
  ...
  const [draft, setDraft] = useState<ConfigurationDraft>(() => record ? configurationDraftFromRecord(section, record) : {
    name: '', description: '', type: section === 'models' ? 'KnowledgeQA' : '', source: section === 'models' ? 'custom' : '', details: '{}',
    apiKey: '', appSecret: '', token: '', enabled: true, url: '', credentialStatus: {},
  });
