...
import type { AgentConfiguration, InstalledSkill, ModelConfiguration, ModelDebugInput, SkillCatalog, SkillCatalogInstallResult, SkillFile, SkillInstallStatus, WeKnoraClient } from '@weknora/api-client';
