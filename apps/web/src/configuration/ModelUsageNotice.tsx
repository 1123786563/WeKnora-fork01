    ...
    <Card className="wk-configuration-usage" role="alert">
      <div className="wk-settings-panel-heading">
        <div>
          ...
          <p className="wk-muted">{modelName} cannot be deleted until its active bindings are removed.</p>
        </div>
      ...
      {knowledgeBaseTotal > 0 ? (
        <section>
          ...
          {knowledgeBaseTotal > details.knowledge_bases.length ? <p className="wk-muted">Showing {details.knowledge_bases.length} of {knowledgeBaseTotal} knowledge-base bindings.</p> : null}
        </section>
      ) : null}
      {agentTotal > 0 ? (
        <section>
          ...
          {agentTotal > details.agents.length ? <p className="wk-muted">Showing {details.agents.length} of {agentTotal} agent bindings.</p> : null}
        </section>
      ) : null}
