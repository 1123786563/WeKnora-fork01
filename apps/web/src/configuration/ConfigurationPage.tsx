...
export function ConfigurationPage({ client }: { client: WeKnoraClient }) {
  ...
  const skillCatalogAvailable = available !== false;
  return <main className="wk-page wk-configuration-page">
    ...
    {skillCatalogAvailable ? <SkillOperations client={client} /> : <Status tone="warning">Skill catalog is unavailable in the current deployment.</Status>}
