...
const SECTION_HEADING_KEYS: Record<string, { title: string; description?: string }> = {
  ...
  usage: { title: 'settings.usage.title', description: 'settings.usage.description' },
...
const descriptions: Record<string, { title: string; description: string }> = {
  ...
  usage: { title: 'Usage', description: 'Personal token usage and cost aggregated by model over the selected window.' },
