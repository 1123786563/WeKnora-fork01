...
const AUDIT_COPY: Record<string, Record<string, string>> = {
  'zh-CN': { title: '审计日志', description: '查看平台级管理操作和结果。', refresh: '刷新', retry: '重试', empty: '暂无审计记录', loading: '加载中...', more: '加载更多', detail: '审计记录详情', close: '关闭', summary: '摘要', request: '请求', details: '详情', time: '时间', actor: '操作者', action: '操作', target: '目标', outcome: '结果', system: '系统', loadFailed: '审计日志加载失败' },
