...
const SYSTEM_COPY: Record<string, Record<string, string>> = {
  'zh-CN': { confirmTitle: '确认高风险配置变更？', confirmBody: '此修改可能影响整个平台的访问或执行能力。', confirm: '确认', cancel: '取消', groups: '系统设置分组', emptyGroup: '此分组暂无配置', restart: '需要重启', secret: '敏感配置', enable: '启用', reset: '恢复默认', saved: '已保存', saveFailed: '保存失败', resetSuccess: '已恢复默认值', resetFailed: '恢复失败' },
  'en-US': { confirmTitle: 'Confirm high-risk configuration change?', confirmBody: 'This change may affect platform access or execution.', confirm: 'Confirm', cancel: 'Cancel', groups: 'System setting groups', emptyGroup: 'No settings in this group', restart: 'Restart required', secret: 'Sensitive configuration', enable: 'Enabled', reset: 'Restore default', saved: 'Saved', saveFailed: 'Save failed', resetSuccess: 'Default restored', resetFailed: 'Restore failed' },
  'ja-JP': { confirmTitle: '高リスク設定の変更を確認しますか？', confirmBody: 'この変更はプラットフォームのアクセスや実行に影響する可能性があります。', confirm: '確認', cancel: 'キャンセル', groups: 'システム設定グループ', emptyGroup: 'このグループに設定はありません', restart: '再起動が必要', secret: '機密設定', enable: '有効', reset: 'デフォルトに戻す', saved: '保存しました', saveFailed: '保存に失敗しました', resetSuccess: 'デフォルトに戻しました', resetFailed: '復元に失敗しました' },
  'ko-KR': { confirmTitle: '고위험 설정 변경을 확인하시겠습니까?', confirmBody: '이 변경은 플랫폼 접근 또는 실행에 영향을 줄 수 있습니다.', confirm: '확인', cancel: '취소', groups: '시스템 설정 그룹', emptyGroup: '이 그룹에는 설정이 없습니다', restart: '재시작 필요', secret: '민감한 설정', enable: '사용', reset: '기본값 복원', saved: '저장됨', saveFailed: '저장 실패', resetSuccess: '기본값으로 복원됨', resetFailed: '복원 실패' },
  'ru-RU': { confirmTitle: 'Подтвердить изменение опасной настройки?', confirmBody: 'Это изменение может повлиять на доступ и выполнение на платформе.', confirm: 'Подтвердить', cancel: 'Отмена', groups: 'Группы системных настроек', emptyGroup: 'В этой группе нет настроек', restart: 'Требуется перезапуск', secret: 'Секретная настройка', enable: 'Включить', reset: 'Восстановить по умолчанию', saved: 'Сохранено', saveFailed: 'Ошибка сохранения', resetSuccess: 'Значение по умолчанию восстановлено', resetFailed: 'Ошибка восстановления' },
};
