...
import { getUploadConfirmDefaultSection, getUploadConfirmSections, isUploadConfirmDismissible, requestUploadConfirmClose, validateUploadConfirm, type UploadConfirmSection } from './upload-confirm.ts';
