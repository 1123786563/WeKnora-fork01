...
export function resolveRoute(pathname: string, options: { development?: boolean } = {}): RouteMatch {
  ...
  // SP14 Task 2 收口 — /platform/billing* (Task 1) and /platform/shared/:token
