...
export function DataSourcesPage({ client, knowledgeBaseId }: { client: WeKnoraClient; knowledgeBaseId: string }) {
  ...
  function showResources(source: DataSource) { setResourceSource(source); setResources([]); setResourceParent(undefined); setResourceTrail([]); void loadResources(source, undefined, []); }
