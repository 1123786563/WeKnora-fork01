...
export const MOBILE_CAPABILITIES: readonly MobileCapability[] = [
  ...
  { key: 'identity', label: 'Members, roles and audit', support: 'read-only', reason: 'Tenant context and role gates are server-owned.' },
  ...
  { key: 'wiki-faq', label: 'Wiki and FAQ', support: 'read-only', reason: 'Editing remains in the Web/desktop surface in this slice.' },
