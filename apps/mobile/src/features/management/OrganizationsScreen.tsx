...
export function OrganizationsScreen() {
  ...
  function removeKnowledgeBaseShare(share: OrganizationShare) {
    ...
    Alert.alert(t('organization.settings.removeShareConfirm', { name: shareResourceLabel(share, 'knowledge-base') }), shareResourceLabel(share, 'knowledge-base'), [
      { text: t('common.cancel'), style: 'cancel' },
  ...
  function removeAgentShare(share: OrganizationShare) {
    ...
    Alert.alert(t('organization.settings.removeAgentShareConfirm', { name: shareResourceLabel(share, 'agent') }), shareResourceLabel(share, 'agent'), [
      { text: t('common.cancel'), style: 'cancel' },
      { text: t('organization.settings.removeShareFromOrg'), style: 'destructive', onPress: () => void (async () => {
        setError('');
