...
export function DataSourcesScreen() {
  ...
  async function run(source: DataSource, operation: 'sync' | 'pause' | 'resume') {
    ...
    try {
      ...
      await load();
    } catch (cause) { setError(cause instanceof Error ? cause.message : operation === 'sync' ? t('dataSource.syncFailed') : operation === 'pause' ? t('dataSource.pauseFailed') : 'Unable to resume data source'); }
