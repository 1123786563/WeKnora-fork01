...
export function DataSourcesScreen() {
  ...
  function openCreate() { setEditing(null); setResources([]); setSelectedResourceIds([]); setDraft({ ...EMPTY_DRAFT, type: types[0]?.type ?? '' }); setError(''); }
  ...
  function openEdit(source: DataSource) { setEditing(source); setResources([]); setSelectedResourceIds(sourceResourceIds(source)); setDraft(nativeDataSourceDraftFrom(source)); setError(''); void loadResources(source); }
