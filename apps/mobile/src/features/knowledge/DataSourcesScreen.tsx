...
export function DataSourcesScreen() {
  ...
  function openCreate() { setEditing(null); setTemporarySourceId(null); setResources([]); setSelectedResourceIds([]); setExpandedResourceIds([]); setDriveFolderToken(''); setDraft({ ...EMPTY_DRAFT, type: types[0]?.type ?? '' }); setError(''); }
