...
export function DataSourcesScreen() {
  ...
  function openCreate() { const type = types[0]?.type ?? ''; setEditing(null); setTemporarySourceId(null); setResources([]); setSelectedResourceIds([]); setExpandedResourceIds([]); setDriveFolderToken(''); setGitlabProjects(type === 'gitlab' ? [{ projectId: '', ref: '', paths: '' }] : []); setDraft({ ...EMPTY_DRAFT, type }); setError(''); }
