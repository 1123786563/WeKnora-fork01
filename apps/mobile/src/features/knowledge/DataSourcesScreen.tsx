...
export function DataSourcesScreen() {
  ...
  async function showLogs(source: DataSource) {
    ...
    catch (cause) { if (requestId === logsRequestId.current) setError(cause instanceof Error ? cause.message : 'Unable to load sync logs'); }
  ...
  async function loadMoreLogs() {
    ...
    catch (cause) { if (requestId === logsRequestId.current) setError(cause instanceof Error ? cause.message : 'Unable to load more sync logs'); }
