...
export function ChatScreen() {
  ...
  return <SafeAreaView style={{ flex: 1 }}>
    <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', padding: 12, borderBottomColor: '#eaecf0', borderBottomWidth: 1 }}>
      ...
      <View style={{ flexDirection: 'row', gap: 12 }}><Pressable onPress={() => router.push('/knowledge')}><Text style={{ color: '#2864dc' }}>Knowledge</Text></Pressable><Pressable onPress={() => void createSession()}><Text style={{ color: '#2864dc' }}>New</Text></Pressable></View>
    </View>
