...
/// Built-in adapter key for WeKnora's session-oriented RAG API.
const String kWeKnoraAdapterKey = 'weknora';

/// Default root of a self-hosted WeKnora backend (API lives under /api/v1).
const String kWeKnoraDefaultBaseUrl = 'http://localhost:8080';
