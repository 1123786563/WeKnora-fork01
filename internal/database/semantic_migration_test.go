...
func TestSemanticMigrationSQLiteUpDownUp(t *testing.T) {
	...
	// tenant_agent_marketplace(109) 与 plugin_previews(110)，全量 up 的终态是最新迁移号。
	require.Equal(t, 110, version)
	...
	// 回滚到 semantic_model_invocations(107) 之下：其上还有 108/109/110 三个迁移。
