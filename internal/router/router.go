...
func NewRouter(params RouterParams) *gin.Engine {
	...
	r.Use(cors.New(cors.Config{
		...
		AllowHeaders:     []string{"Origin", "Content-Type", "Accept", "Authorization", "X-API-Key", "X-Request-ID", "X-Tenant-ID", "X-Embed-Session", "X-Embed-Visitor", "X-External-User-ID", "X-External-User-Token"},
