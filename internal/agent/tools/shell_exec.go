...
- CWD defaults to /workspace on every call; cd does not persist. work_dir selects any directory inside the session sandbox; missing directories are created as the same user.
