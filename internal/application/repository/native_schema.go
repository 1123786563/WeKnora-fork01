...
func NativeSchemaManifest() []NativeSchemaTable {
	return []NativeSchemaTable{
		...
		nativeTable("native_memory_jobs", []string{"tenant_id", "subject_id", "job_id", "generation", "through_event_id", "status", "session_app_name", "session_user_id", "session_id"}, []string{"tenant_id", "subject_id", "job_id"}),
