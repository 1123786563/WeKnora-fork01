# Semantica experiments: V01 import-contract profile + bounded capability probe
...
SEMANTICA_WHEEL=/tmp/semantica-0.6.8-py3-none-any.whl UV_PROJECT_ENVIRONMENT=/tmp/semantica-v01-clean uv run --project semantic/experiments python semantic/experiments/verify_version.py --output docs/plans/semantica/capability-evidence.json
```
