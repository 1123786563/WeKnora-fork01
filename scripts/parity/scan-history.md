...
| 2026-09-21T08-55-14 | 60 | 60 | 8.00 | 闭环扫描：与上轮持平；members 20.3/KB 弹窗 16-19 高于各自底噪 9-14pp，仍有可修内容——派修复轮⑨（4 域聚焦） |
| 2026-09-21T10-17-45 | 60 | 60 | 8.00→6.85 | 修复轮⑨（4 域，2 代理超时但工作已落盘）：ix-kb-settings 16.6→6.64、ix-kb-list-create 19.3→6.83、members 20.3→12.70、parser 13.4→9.70、weknoracloud 11.2→7.69、ollama 11.2→8.89（KB 设置遮罩 blur+实底、解析引擎卡配色徽章/行高、云面板行高、ollama 告警/tag 形态）；kb-wiki-tab-graph 上轮 98.6 为 Vue 瞬态，本轮恢复 6.53 |