...
- N016/N017 MCP directory controls (2026-09-15): MCP tool search and enabled/approval policy toggles now use shared `Input`/`Switch` controls while preserving controlled state, accessibility labels, disabled behavior and mutation callbacks. Web typecheck and full Web regression 895/895 pass. Evidence: `evidence/vue-react-parity/2026-09-15-r128-mcp-directory-controls.md`; protected backend mutation and same-session Vue visual comparison remain open.
